...
class StudentRegController extends Controller
{
    ...
    public function StudentRegStore(Request $request)
    {
        DB::transaction(function () use ($request) {
            ...
            $student = User::where('suertype', 'Student')->orderBy('id', 'DESC')->first();
            ...
            if ($student == null) {
                ...
                $student = User::where('suertype', 'Student')->orderBy('id', 'DESC')->first()->id;
                $studentId = $student + 1;
                if ($studentId < 10) {
                    $id_no = '000' . $studentId;
                } elseif ($studentId < 100) {
        ...
        $notification = array(
            'message' => 'Student Registration Inserted Succesfully',
            'alert-type' => 'success'
        );
    ...
    public function StudentRegUpdate(Request $request, $student_id)
    {
        ...
        $notification = array(
            'message' => 'Student Registration Update Succesfully',
            'alert-type' => 'success'
        );
        return redirect()->route('student.registration.view')->with($notification);
    }
    ...
    public function StudentUpdatePromotion(Request $request, $student_id)
    {
        ...
        $notification = array(
            'message' => 'Student Promotion Update Succesfully',
            'alert-type' => 'success'
        );
        return redirect()->route('student.registration.view')->with($notification);
    }
