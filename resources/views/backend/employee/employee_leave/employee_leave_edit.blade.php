...
@section('admin')
                      ...
                      <div class="row">
                          ...
                          <div class="form-group">
                            ...
                            <div class="controls">
                              <select name="employee_id" required="" class="form-control">
                                <option value="" selected="" disabled>Select Employee Name
                                </option>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="controls">
                              <input type="date" name="start_date" id="increment_salary"
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="controls">
                              <select name="leave_purpose" id="leave_purpose" required=""
                                class="form-control">
                                <option value="" selected="" disabled>Select Employee Name
                                </option>
                                @foreach ($leave_purposes as $leave)
                                  <option value="{{ $leave->id }}"
                                    {{ $editData->leave_purpose == $leave->id ? 'selected' : '' }}>
                                    {{ $leave->name }}</option>
                                @endforeach
                          ...
                          <div class="form-group">
                            ...
                            <div class="controls">
                              <input type="date" name="end_date" class="form-control"
                                placeholder="Class Name" value="{{ $editData->end_date }}">
  ...
  <script text="text/javascript">
    $(document).ready(function() {
      $(document).on('change', '#leave_purpose', function() {
